...
export class AnuncioComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.anuncioService
      ...
      .subscribe(
        (res: HttpResponse<IAnuncio[]>) => this.paginateAnuncios(res.body, res.headers),
  ...
  trackId(index: number, item: IAnuncio) {
    return item.id;
  }
  ...
  protected paginateAnuncios(data: IAnuncio[], headers: HttpHeaders) {
